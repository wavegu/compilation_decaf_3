...
public abstract class Tree {
    ...
    public static final int COND = POSTDEC + 1;
...
/*----------------------------------ADDED IN PA1-----------------------*/
    ...
    public static class Numinstances extends Expr {
      ...
      public String ident;
        ...
        public Numinstances(int kind, String s, Location loc) {
            super(kind, loc);
            this.ident = s;
        }

      private void numinstancesToString(IndentPrintWriter pw, String op) {
        pw.println(op);
        pw.incIndent();
        pw.println(ident);
        pw.decIndent();
      ...
      @Override
      public void printTo(IndentPrintWriter pw) {
          numinstancesToString(pw, "numinstances");
      }
   }
   ...
   /*------------------------------------------------*/
    ...
    public static class Unary extends Expr {
      ...
      public void printTo(IndentPrintWriter pw) {
        ...
        case POSTDEC:
          ...
          break;
        case NUMINSTANCES:
          unaryOperatorToString(pw, "numinstances");
      }
      }
   }
    ...
    public static class Trinary extends Expr {
      ...
      private void trinaryOperatorPrintTo(IndentPrintWriter pw, String op) {
        pw.println(op);
        pw.incIndent();
        left.printTo(pw);
        middle.printTo(pw);
      ...
      public void printTo(IndentPrintWriter pw) {
        switch (tag) {
        case COND:
          trinaryOperatorPrintTo(pw, "cond");
          break;
        }
      }
    }
    ...
    public static abstract class Visitor {
        ...
        public void visitGuardedIfStmt(GuardedIfStmt that) {
            visitTree(that);
        }
